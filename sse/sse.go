// Package sse implements Server-Sent Events (SSE) support for ogen.
package sse
...
// scanLines is a custom split function for bufio.Scanner that handles different line endings.
